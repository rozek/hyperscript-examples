...
* [Pointer Events](https://svelte.dev/repl/cfebf1ddf4b942868f769ddc15ec209d) - shows the sequence of "pointer events" fired when moving and clicking the "pointer" (i.e., a mouse, finge or stylus) within and outside a specific HTML element (and beware: some pointer events "bubble", others do not!) Note: modern browsers should work right away, for olde browsers, a [polyfill](https://github.com/Rich-Harris/Points) has been added
