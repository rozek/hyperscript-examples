...
* [fetching from "keyvalue.immanuel.co"](https://svelte.dev/repl/505039fd942f4ecdb362d84202988b66) - "keyvalue.immanuel.co" is an extremely simple free online key-value store. This example shows how create a new store and set/get values from it
